...
class LoadingScreen : GameScreen
{
    ...
    public bool LoadingIsSlow { get; set; }

    public IGameScreen[] ScreensToLoad { get; set; }
    ...
    /// </summary>
    public LoadingScreen(IScreenManager manager, Game game) : base(manager)
    {
    ...
    public override void Update(TimeSpan elapsedTime, TimeSpan totalTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
    {
        ...
        if (this.otherScreensAreGone)
        {
            ...
            foreach (var screen in this.ScreensToLoad)
            {
                if (screen != null)
                {
    ...
    public override void Draw(TimeSpan elapsedTime, TimeSpan totalTime)
    {
        ...
        {
            var gameScreens = this.ScreenManager.GetScreens();
        ...
        if (this.LoadingIsSlow)
        {
            ...
            var textSize = this.font.MeasureString(message);
            ...
            this.spriteBatch.DrawString(this.font, message, textPosition, color);
